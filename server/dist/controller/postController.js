...
exports.getbook = exports.addBook = exports.returning = void 0;
var book_1 = __importDefault(require("../config/aws/book"));
var aws_sdk_1 = __importDefault(require("aws-sdk"));
function returning(info) {
    var book = info;
    return book;
}
...
function addBook(info) {
    return __awaiter(this, void 0, void 0, function () {
        var newbook, docClient, params, result;
...
function getbook(title) {
    return __awaiter(this, void 0, void 0, function () {
        var book_title, docClient, params, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    book_title = title;
